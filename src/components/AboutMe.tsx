    ...
    <div className="min-h-screen bg-[#030303] text-white font-inter selection:bg-indigo-500/30">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              >
                <span className="text-indigo-400 font-mono text-sm tracking-widest uppercase mb-2 block">{tAbout("title")}</span>
                <h1 className="text-4xl md:text-6xl font-sora font-black tracking-tighter mb-6 leading-tight">
                  {tAboutPage("heroTitlePrefix")} <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">{tAboutPage("heroTitleAccent")}</span>
                </h1>
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">{tAboutPage("location")}</span>
              </motion.div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              {[tAboutPage("skills.s1"), tAboutPage("skills.s2"), tAboutPage("skills.s3"), tAboutPage("skills.s4"), tAboutPage("skills.s5"), tAboutPage("skills.s6"), tAboutPage("skills.s7"), tAboutPage("skills.s8")].map((skill) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-sora font-black tracking-tighter mb-16 text-center uppercase">{tAboutPage("timelineTitle")}</h2>
          ...
          <div className="space-y-12 relative before:absolute before:left-0 md:before:left-1/2 before:top-0 before:bottom-0 before:w-px before:bg-white/10">
            ...
            <div className="relative flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="md:w-1/2 md:pr-12 md:text-right">
                <span className="text-indigo-400 font-mono text-xs mb-1 block">{tAboutPage("timeline.t1.period")}</span>
            ...
            <div className="relative flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="md:w-1/2 md:pr-12 md:text-right">
                <span className="text-slate-500 font-mono text-xs mb-1 block">{tAboutPage("timeline.t2.period")}</span>
            ...
            <div className="relative flex flex-col md:flex-row items-center md:items-start gap-8">
              <div className="absolute left-[-4px] md:left-1/2 md:-translate-x-1/2 w-2 h-2 rounded-full bg-slate-700 z-10" />
              <div className="md:w-1/2 md:pr-12 md:text-right">
                <span className="text-slate-500 font-mono text-xs mb-1 block">{tAboutPage("timeline.t3.period")}</span>
