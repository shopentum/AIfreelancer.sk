...
Dátum: 2026-05-08 (úprava: §1.2 prioritizácia iniciatív / MVP rozhodovanie; §1.1 LLM feedback)

---

## Changelog (strategický dokument)

- **2026-05-08:** doplnené **§1.2** — prioritizácia iniciatív (business dopad, naliehavosť, odblokovanie, náročnosť; odkaz na WSJF ako konzistentný rámec).
...
### 1.2 Prioritizácia iniciatív a MVP rozhodovanie

Rozvoj Editorial Copilotu bude prioritizovaný podľa kombinácie:

- **business dopadu**,
- **naliehavosti**,
- **odblokovania ďalších capability vrstiev**,
- **implementačnej náročnosti**.

Pre porovnávanie väčších iniciatív a capability vrstiev je možné používať princíp **WSJF (Weighted Shortest Job First)**, ktorý umožňuje konzistentnejšie rozhodovanie medzi:

- rýchlymi vysoko-dopadovými zlepšeniami,
- infra / refaktoring iniciatívami,
- AI capability vrstvami,
- UX / workflow optimalizáciami.

**Cieľom nie je „dokonalé skórovanie“**, ale **transparentné a opakovateľné** rozhodovanie o poradí investícií do CMS a Editorial Copilotu.

**Prakticky** to znamená, že prioritu nezískava automaticky najväčšia iniciatíva, ale tá, ktorá prináša najlepší pomer **hodnota × načasovanie × strategické odblokovanie** vo vzťahu k **implementačnej náročnosti** (v duchu WSJF; presný výpočet necháva na grooming tímu — dokument fixuje zámer, nie jednu povinnú šablónu).
