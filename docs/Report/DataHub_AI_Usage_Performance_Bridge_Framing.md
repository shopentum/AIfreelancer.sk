...
Až po dodaní Pent podkladov (**parent DHUB-3138** + jeho subtask) môže nasledovať samostatný technický request v jazyku analytiky podľa princípov tohto dokumentu (grain, join kľúče, CAP per feature, recurring výstup, dokumentácia medzier). **Do DHUB-3138 ani jeho Pent subtasku sa tento krok neprepája.**
